...
const PostCard = ({post}) => {
  ...
  const postWithHahtags = post.content.replace(/(#\w+)/g, '<span class="text-indigo-600">$1</span>')
  ...
  return (
    <div className='bg-white rounded-xl shadow p-4 space-y-4 w-full max-w-2xl'>
        ...
        {/* Content */}
        {post.content && <div className='text-gray-800 text-sm whitespace-pre-line' dangerouslySetInnerHTML={{__html: postWithHahtags}} />}
