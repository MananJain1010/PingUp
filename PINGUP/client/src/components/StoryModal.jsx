  ...
  return (
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
              ...
              )}
              {
                 mode === 'media' && previewUrl && (
                     media?.type.startsWith('image') ? (
                         ...
                         <video src={previewUrl} classsName='object-contain max-h-full'/>
                    )
                 )
              }
            ...
            })} className='Flex itens-center justify-center gap-2 text-white py-3 nt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:fron-indigo-600 hover:to-purple-700 active:scale-95 transition cursor-pointer'>
